  ...
  constructor(
    ...
    this.device.onevent = event => {
      ...
      if (event.name === 'isFaulted') {
        ...
        this.service.updateCharacteristic(this.platform.Characteristic.SmokeDetected, this.getContactDetected());
      }
    ...
    this.device.onchange = async (_oldState, newState) => {
      ...
      this.service.updateCharacteristic(this.platform.Characteristic.SmokeDetected, this.getContactDetected(true));
      this.temperatureService?.updateCharacteristic(this.platform.Characteristic.CurrentTemperature, this.getTemperature());
